    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl w-full">
        ...
        <p className="text-xl text-gray-600 text-center mb-12">
          Your intelligent companion for stock analysis and portfolio management
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 group-hover:text-indigo-600">
                Stock Analysis
              </h2>
              <p className="text-gray-600">
                Get detailed analysis of stocks with technical indicators, fundamental data, and AI-powered insights.
              </p>
            </div>
          </Link>
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
              ...
              <p className="text-gray-600">
                Create a personalized investment portfolio based on your risk appetite and investment goals.
              </p>
            </div>
          </Link>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-600">
            Our platform uses cutting-edge AI technology to provide you with accurate analysis and personalized recommendations.
          </p>
        </div>
      </div>
    </main>
