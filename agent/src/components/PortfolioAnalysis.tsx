        ...
        <div className="max-w-5xl mx-auto">
          ...
          {portfolioData && (
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Stock Recommendations</h2>
                      ...
                      {Object.entries(portfolioData.portfolio.recommendations.stock_recommendations).map(([sector, stocks]) => (
                        <React.Fragment key={sector}>
                          <tr className="bg-gray-50">
                            <td colSpan={6} className="px-6 py-3 text-sm font-medium text-gray-900">
                              {sector}
                            </td>
                          </tr>
                          {stocks.map((stock, index) => (
                            <tr key={`${sector}-${index}`}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {stock.suggested_shares}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ${stock.fundamentals.current_price.toLocaleString()}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
